...
function HomePage() {
  ...
  <button className='bg-[#FF9F0D] text-white w-[100px] h-[30px] md:w-[190px] md:h-[60px] rounded-[40px] mt-[32px] hover:bg-yellow-800'>
    See More
      ...
      <div className="mt-[50px] md:mt-0 ">
        <Image src={foodpic1} alt="Hero Image" className="" width={1000} height={45} />
        <div className="flex flex-col md:flex-row mt-[16px] md:mt-[0]">
          <Image src={foodpic2} alt="Hero Image" className="mr-[16px] pt-[60px]" />
          <Image src={foodpic3} alt="Hero Image" className="pt-[40px]" height={16} width={332} />
        </div>
        <div className="mt-[50px] md:mt-0 ">
          <Image src={Our}alt="Hero Image"className="mr-[16px] pt-[60px]" width={1320} height={656} />
          </div>
          <div className="mt-[50px] md:mt-0 ">
          <Image src={ch}alt="Hero Image"className="mr-[16px] pt-[60px]" width={1320} height={656} />
          </div>
          <div className="mt-[50px] md:mt-0 ">
          <Image src={another}alt="Hero Image"className="mr-[16px] pt-[60px]" width={1320} height={656} />
          </div>
